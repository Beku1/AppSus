  ...
  template: `
    ...
    <section class="note-edit-container">
            ...
            <div class="edit-container">
                <input class="edit-input-title" placeholder="Title" @change="saveChanges" type="text" v-model="note.info.title">
                <input class="edit-input-content" @change="saveChanges" v-if="note.info.txt" type="text" v-model="note.info.txt">
                <input class="edit-input-content" @change="saveChanges" v-if="note.info.imgUrl" type="text" v-model="note.info.imgUrl">
